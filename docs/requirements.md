...
- [ ] La simulación **no es editable**: crear (este RF) y eliminar (RF-SIM-004) son sus dos únicas operaciones. Ni el monto simulado ni el tramo se ajustan a mano.
