...
> El "origen" de cada fase refiere a los pendientes del TODO del `README.md` (F1–F4 y los dos fixes de 1.1.3/1.1.4). Se anota como trazabilidad del origen de cada fase.
